...
looker.plugins.visualizations.add({
  ...
  updateAsync: function(data, element, config, queryResponse, details, done) { 
    ...
    for (i = 0; i < cols.length; i++) {
      ...
      options['axis_' + iN] = {type: "string", label: "Axis", order: i*4+1, display_size: "half", display: 'select', values: [{"-":null},{"x1":'x1'},{"y1":'y1'},{"x2":'x2'},{"y2":'y2'},{"x3":'x3'},{"y3":'y3'},{"x4":'x4'},{"y4":'y4'}]}
      options['type_' + iN] = {type: "string", label: "Type", order: i*4+2, display_size: "half", display: 'select', values: [{"-":null},{"values":'values'},{"labels":'labels'},{"y lower bound":'y_lb'},{"y upper bound":'y_ub'},{"x lower bound":'x_lb'},{"x upper bound":'x_ub'},{"hovertext":'hovertext'}]}
