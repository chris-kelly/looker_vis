...
looker.plugins.visualizations.add({
  ...
  options: { 
    ...
    x1: { order: 0, label: "Base trace 1: x axis", display_size: "half", type: 'string', section: 'Trace 1', display: 'select', hidden: false, values: [{"-": null}]},
    y1: { order: 0, label: "Base trace 1: y axis", display_size: "half", type: 'string', section: 'Trace 1', display: 'select', hidden: false, values: [{"-": null}]},
    x2: { order: 0, label: "Base trace 2: x axis", display_size: "half", type: 'string', section: 'Trace 2', display: 'select', hidden: true, values: [{"-": null}]},
    y2: { order: 0, label: "Base trace 2: y axis", display_size: "half", type: 'string', section: 'Trace 2', display: 'select', hidden: true, values: [{"-": null}]},
    x3: { order: 0, label: "Base trace 3: x axis", display_size: "half", type: 'string', section: 'Trace 3', display: 'select', hidden: true, values: [{"-": null}]},
    y3: { order: 0, label: "Base trace 3: y axis", display_size: "half", type: 'string', section: 'Trace 3', display: 'select', hidden: true, values: [{"-": null}]},
    x4: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 4', display: 'select', hidden: true, values: [{"-": null}]},
    y4: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 4', display: 'select', hidden: true, values: [{"-": null}]},
    x5: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 5', display: 'select', hidden: true, values: [{"-": null}]},
    y5: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 5', display: 'select', hidden: true, values: [{"-": null}]},
    x6: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 6', display: 'select', hidden: true, values: [{"-": null}]},
    y6: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 6', display: 'select', hidden: true, values: [{"-": null}]},
    x7: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 7', display: 'select', hidden: true, values: [{"-": null}]},
    y7: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 7', display: 'select', hidden: true, values: [{"-": null}]},
    x8: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 8', display: 'select', hidden: true, values: [{"-": null}]},
    y8: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 8', display: 'select', hidden: true, values: [{"-": null}]},
    x9: { order: 0, label: "Base trace 4: x axis", display_size: "half", type: 'string', section: 'Trace 9', display: 'select', hidden: true, values: [{"-": null}]},
    y9: { order: 0, label: "Base trace 4: y axis", display_size: "half", type: 'string', section: 'Trace 9', display: 'select', hidden: true, values: [{"-": null}]},
